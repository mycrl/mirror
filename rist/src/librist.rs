...
impl Default for RistDataBlock {
    fn default() -> Self {
        Self {
            rist_ref: null(),
            payload: null(),
...
extern "C" {
    ...
    pub fn rist_logging_set(
        ...
        level: RistLevel,
        proc: extern "C" fn(*const c_void, RistLevel, *const c_char) -> c_int,
        data: *const c_void,
    ...
    pub fn rist_receiver_data_callback_set2(
        ctx: *const c_void,
        proc: extern "C" fn(*const c_void, *const RistDataBlock) -> c_int,
        data: *const c_void,
    ) -> c_int;
    /// Create Sender
    ///
    ...
    pub fn rist_sender_data_write(ctx: *const c_void, data: *const RistDataBlock) -> c_int;
    ...
    /// be set to NULL
    pub fn rist_receiver_data_block_free2(data: *mut *const RistDataBlock);
}
