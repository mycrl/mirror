...
pub use crate::{
    api::SRT_TRACEBSTATS as TraceStats, listener::Listener, options::SrtOptions, socket::Socket,
};

use std::ffi::CStr;

use api::{srt_cleanup, srt_getlasterror_str, srt_startup};
...
mod api {
    ...
    extern "C" {
        ...
        /// particular:
        ///
        /// * No socket in the system has been bound to this port ("free
        ///   binding"), or
        ///
        /// * A socket bound to this port is bound to a certain address, and
        ///   this binding is
        ...
        ///
        /// * Its binding address and UDP-related socket options match the
        ///   socket to be bound.
        /// * Its [`SRTO_REUSEADDR`](API-socket-options.md#SRTO_REUSEADDRS) is
        ///   set to *true* (default).
        ///
        ...
        ///
        /// * shareable: This binding can be shared with the requested binding
        ///   if it's compatible.
        ///
        ...
        /// function:
        ///
        /// * [`srt_listen_callback`](#srt_listen_callback) installs a user
        ///   function that will
        ...
        /// **Arguments**:
        ///
        /// * [`u`](#u): can be an SRT socket or SRT group, both freshly created
        ///   and not yet used for any connection, except possibly
        ...
        /// **NOTES:**
        ///
        /// 1. The socket used here may be [bound by `srt_bind`](#srt_bind)
        ///    before connecting,
        ...
        ///
        /// 2. This function is used for both connecting to the listening peer
        ///    in a caller-listener
        ...
        ///
        /// 3. When [`u`](#u) is a group, then this call can be done multiple
        ///    times, each time
        ...
        /// **Arguments**:
        ///
        /// * [`u`](#u): Socket used to send. The socket must be connected for
        ///   this operation.
        /// * `buf`: Points to the buffer to which the payload is copied.
        /// * `len`: Size of the payload specified in `buf`.
        /// * `mctrl`: An object of [`SRT_MSGCTRL`](#SRT_MSGCTRL) type that
        ///   contains extra
        /// parameters.
        ///
        ...
        ///
        /// 2. In **file/message mode**, exactly one message is retrieved, with
        ///    the
        ...
        ///
        /// 3. In **live mode**, the function behaves as in **file/message
        ///    mode**, although the
        ...
        /// boundaries.
        ///
        /// 3. In **live mode**, you are only allowed to send up to the length
        ///    of
